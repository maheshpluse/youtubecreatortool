...
Component _p(String body) => p(classes: 'mb-3', [text(body)]);
      ...
      [
        for (final row in rows)
          li(classes: 'border-l-2 border-yt-gray-200 dark:border-yt-gray-700 pl-3', [
            strong(classes: 'text-yt-gray-900 dark:text-white', [text(row[0])]),
            span([text(' — ${row[1]}')]),
          ]),
      ],
    );
...
Component _updated() => p(
      ...
      [text('Last updated: $legalLastUpdated  ·  Effective: $legalLastUpdated')],
    );
...
List<Component> privacyPolicyContent() => [
      ...
      _callout([
        strong([text('The short version. ')]),
        text('There are no accounts and no passwords. We do not ask for your name, we do '
      ...
      p(classes: 'mb-3', [
        text('Google\'s handling of data sent to its APIs is described in the '),
      ...
      p(classes: 'mb-3', [
        text('Google, as a third-party vendor, uses cookies to serve ads on this site and '
        ...
        text(', opt out of many vendors at once at '),
        ...
        text(' (Australia). How Google uses data from sites that use its services is '
            'explained at '),
      ...
      p(classes: 'mb-3', [
        text('If you are unhappy with our response, you may complain to the Office of the '
      ...
      p(classes: 'mb-3', [
        text('For any privacy question or request, email '),
        a(
          href: 'mailto:$legalContactEmail',
          classes: 'font-medium text-yt-red hover:underline',
          [text(legalContactEmail)],
        ),
        text('. A postal address is available on request. We ask that you contact us first '
...
List<Component> termsOfServiceContent() => [
      ...
      _callout([
        ...
        text('Section 13 limits our liability and section 11 disclaims warranties. If you '
      ...
      _h2('2. Who we are'),
      p(classes: 'mb-3', [
        text('The Service is operated by CreatorTools.io LLC, a limited liability company '
      ...
      p(classes: 'mb-3', [
        text('Most problems can be resolved quickly. Before starting formal proceedings, '
            'please email '),
        a(
          href: 'mailto:$legalContactEmail',
          classes: 'font-medium text-yt-red hover:underline',
        ...
        text(' describing the issue and the resolution you want. We will try to resolve it '
